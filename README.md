...
- **The converter silicon, costed.** With NRE discarded, a full 1.79 TB/s converter (1 root + 9 leaf dies, TSMC N5) is **~$572/system at volume** — *packaging*-dominated, not the N5 wafers — i.e. **~3% of the K3 DRAM bill**. (Full model in strata_v §13.)
