...
## Why you can't buy a 2 TiB / 1.79 TB/s GPU memory expander (2026-07)
- Buyable CXL DDR5 expanders: **Astera Labs Leo** — 2 TB DDR5-5600/controller, CXL 2.0 x16 (~64 GB/s/dir), Azure M-series preview 2025-11-18 (Leo portfolio brief, archived); **SMART CXA-8F2W** AIC — 4 TB/card (8× RDIMM), 64 GB/s, ~200 ns; **Micron CZ120 / Samsung CMM-D / SK hynix CMM** — 96–256 GB E3.S (~36 GB/s, CXL 2.0 x8); **Samsung CMM-B** — 2 TB/4U appliance, 60 GB/s; **Marvell Structera X 2504** — >4–6 TB/controller (sampling), 200 GB/s media-side but host x16 CXL ≈ 64 GB/s/dir
- CXL rides PCIe electricals: PCIe 5.0 x16 ≈ 64 GB/s/dir, PCIe 6.0 x16 ≈ 128 GB/s/dir → 1.79 TB/s needs ~28× Gen5 x16 links; CXL memory is CPU-host only; no merchant GPU consumes CXL.mem as VRAM (only exception: Panmnesia CXL-GPU prototype on a purpose-built GPU — no NVIDIA/AMD/Intel adoption) (CXL 3.0 whitepaper, archived; SemiAnalysis)
- NVIDIA Grace: a GPU reaches up to **480 GB** LPDDR5X at **~450 GB/s/dir** (NVLink-C2C 900 GB/s total, bidirectional); Grace-Grace 960 GB config @ 768 GB/s; GH200 = 480 GB LPDDR5X + 96/144 GB HBM; soldered, superchip-only, non-consumer (NVIDIA Grace/GH200 whitepaper) — cf. DGX Spark GB10 = 128 GB unified @ 273 GB/s, $4,699
- SambaNova SN40L: up to **1.5 TiB DDR/socket @ >200 GB/s** + 64 GiB HBM + 520 MiB SRAM (arXiv:2405.07518, archived); shipping SambaRack SN40-16 = 256 GB DDR/socket (4 TB/rack) (SambaRack datasheet, archived); proprietary appliance, DIMM-pluggable
- Native GPU ceilings at VRAM bandwidth: **96 GB GDDR7 @ 1.79 TB/s** (RTX PRO 6000, max sold) · **288 GB HBM3e @ 8 TB/s** (B300, max sold) → 2.11 TiB = 22× / 7.5× beyond; merchant-GPU generic ingress = one PCIe x16 (~64 GB/s); NVLink Fusion licenses CPUs into racks, not memory onto merchant cards
- Full verification dossier: /tmp research corpus (`H_` prefix); archived vendor/arXiv/consortium docs in `pricing_evidence/memory_expanders/`

## Advanced IC-substrate (ABF) supply + all-in cost — masks, boards, power, the 2026–28 shortage (2026-07)
- Shortage "official" H1 2026, gap through 2027–2028 — DigiTimes (2026-07-14 a20260714PD214; 2026-04-08) [single-root, uncontradicted]; SEMCO FC-BGA demand >50% over capacity, sold out — Korea Herald (2026-04-03), Seoul Economic Daily (2026-04/05) [confirmed-multi]; CoWoS gap narrowing 20%→10% (bottleneck migrating interposer→substrate) — TrendForce (2026-06-15)
- Multi-year reservations (filing-grade): **Marvell FY2026 10-K (SEC)** — substrate capacity-reservation agreements 4–10-yr terms, ≥$458.2M committed FY2027–2033; Kinsus order visibility 2028–2029 + US$744M expansion — DigiTimes (2026-02-02); SEMCO 2026 pre-booked (Alphabet/Tesla/Apple/AWS/Broadcom) — DigiTimes (2025-11-24); Nvidia booked >½ of TSMC CoWoS 2026–27 expansion
- Bottleneck is high-layer/AI-class substrate + upstream T-glass/CCL, NOT the film or commodity substrate — Kinsus on record (DigiTimes 2025-08-21: commodity ABF/BT still surplus, AI-class tight); T-glass structural >10% shortfall (Commercial Times 2025-07-22)
- Prices: **Ajinomoto ABF film +~30% effective Q3 2026** (formally notified, 2nd hike) — DigiTimes (2026-05-13) [confirmed-multi; NOT via AtlasPCB, whose engineering blog carries fabricated Ajinomoto plant details — excluded]; BT/T-glass +up to 20% from Jul/Aug 2025 — TrendForce (2025-07-22); substrate contract +5–10% / spot +>30%, SEMCO ASP +~10% — Commercial Times / Mirae Asset (2026); Ajinomoto ABF margin >50%
- Drivers: build-up layers 3+3→13+13, AI substrates 16–22L, bodies >100–120 mm; +20% layers / +30% area per server-CPU gen with yield 60–70%→40–50% (≈2× capacity per good unit) — TrendForce; CoWoS 13k→120–140k wpm (2023→2026)
- Capacity response (lands FY2027–28, no sourced view closes the gap before ~2028): Ibiden ¥500B FY26–28 (2.5× AI-substrate by FY2028, MP FY2027) — Ibiden IR; Unimicron NT$25.4B; AT&S €1.5–2B Kulim (with AMD, HVM since 2025-05); SEMCO >₩1tr/yr; Kinsus US$744M; Toppan Niigata (Jan 2026) + Singapore (late 2026); Zhen Ding Thailand; Ajinomoto film +50% by 2030, 3rd plant only 2032. Glass (Absolics/SKC Georgia, Intel EMIB-glass, Samsung): pilot 2026, volume 2027–2030, no relief before 2028
- Single-source flags: "20–30-wk lead times" (Commercial Times, paralleled by Mordor "28 wk/14-layer"); blended ASP $65→$82 (Mordor only); "10/21/42%" gap series (unpinnable — treat as unverified)
- All-in cost under "R&D free": N5 full mask set ~$12–20M/die type [analyst — SemiAnalysis; SemiWiki (Fred Chen, EUV >$300k/DUV <$150k); WikiChip ~81 masks/11–13 EUV]; IBS "$542M to design a 5nm chip" ≈95% labor / ≈5% tooling [analyst — SemiEngineering]; 86% of 2024 ASIC projects respin [analyst — Siemens/Wilson Research]; DDR5 PHY/controller IP silicon-proven on TSMC N5 since 2020, license ~$3–6M+royalty [vendor Synopsys/Cadence; analyst IPnest]; device-mode GDDR7 PHY has NO licensable IP — catalog is entirely host-side [vendor Design&Reuse]; server-board anchor Supermicro H13DSH 24-DIMM ~$800 [street]; PSU ~$330 [street]; EIA industrial electricity 8.5–9¢/kWh [primary]
- Packaging class (root is flagship-but-catalog-precedented): AMD Versal VP1902 = 5,601-ball, 70×70 mm, 0.92 mm-pitch catalog FPGA [vendor AMD XMP463]; EPYC SP5 6,096 contacts; RTX 5090 GB202 63×56 mm, 512-bit 28G PAM3 (the SI proof) [media]; OSAT FCBGA HVM envelopes — ASE 77.8×77.5 mm, SPIL >9,352 balls, Amkor ≤67.5 std/85 qual [vendor]. Every FCBGA substrate is a bespoke per-die design (no catalog substrate exists, for anyone)
- Full dossiers + ~90 archived captures: /tmp research corpus (`N_`/`P_`/`ABF_` prefixes); load-bearing docs in `pricing_evidence/substrate_supply/`
